    ...
    <div className="relative" ref={ref}>
      <button
        ...
        className={`flex items-center gap-1.5 rounded-2xl border px-3.5 py-2.5 text-xs font-semibold transition-all ${
          !allSelected
            ? 'bg-[#c49a3c]/10 border-[#c49a3c]/40 text-[#a67f2e]'
...
export default function BookClassPage() {
  ...
  const schedule = useMemo(
    () => shiftKeysToAnchor(SCHEDULE_TEMPLATE, SCHEDULE_ANCHOR, today),
    [today],
  );
  ...
  const filteredSchedule = useMemo(() => {
    ...
    return result;
  }, [schedule, coachFilter, classFilter]);
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8">
        ...
        <div className="pt-6 pb-5 border-b border-[#D4CDB5]/60 flex items-center justify-between gap-4">
          <div className="flex items-center gap-4">
            <button
              ...
              className="hidden md:flex w-10 h-10 rounded-full bg-[#EDE8D8] border border-[#D4CDB5]/60 items-center justify-center text-[#1E2A35] hover:bg-[#E3DCC8] active:scale-95 transition-all shrink-0"
            >
              <ArrowLeft size={18} />
            </button>
            <div>
        ...
        <div className="pt-5 pb-4 flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <div className="hidden md:flex items-center bg-[#EDE8D8] rounded-2xl p-1 border border-[#D4CDB5]/50">
        ...
        <div className="pb-10 flex gap-6 items-start">
          ...
          {/* ── LEFT: small month calendar (desktop only) ── */}
          ...
          <div className="flex-1 min-w-0 flex flex-col gap-4">
            ...
            <p className="text-[#8A7E6E] text-xs text-center">
              <span className="md:hidden">Tap a class to book it, or a day header to see its full schedule</span>
                ...
                <div className="border-t border-[#c49a3c]/30 bg-white px-6 py-5 shrink-0">
                  ...
                  <div className="flex items-center justify-between gap-3">
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 bg-[#c49a3c] text-white font-bold text-sm rounded-full py-3.5 px-6 shadow-[0_4px_16px_rgba(196,154,60,0.35)] hover:bg-[#a67f2e] active:scale-[0.97] transition-all whitespace-nowrap"
