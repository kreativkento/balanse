        ...
        <div className={`bg-white rounded-3xl border border-[#E8E2D2]/80 shadow-sm overflow-hidden mb-10 ${CARD_HOVER_GROW}`}>
          ...
          <div className="px-7 py-5 border-b border-[#E8E2D2]/70 flex items-center justify-between flex-wrap gap-3">
            ...
            <div className="flex items-center gap-3">
              ...
              <Link to="/admin-payments" className="text-[#C49A3C] text-xs font-semibold hover:text-[#A67E2A] transition-colors">
                View all →
              </Link>
            </div>
          </div>
          ...
          <div className="flex flex-col gap-5">
            ...
            <div>
              ...
              <div className={`bg-white rounded-3xl border border-[#E8E2D2]/80 shadow-sm p-5 ${CARD_HOVER_GROW}`}>
                ...
                <div className="mt-4 pt-4 border-t border-[#F0EBE0] flex flex-col gap-2">
                  ...
                  <Link to="/admin-absence" className="flex items-center gap-2.5 px-3 py-2 rounded-xl bg-[#F8F3E8] border border-[#E8E2D2]/80 hover:bg-[#EDE8D8] transition-colors group">
                    <BookOpen size={13} className="text-[#8A7E6E] shrink-0" />
                    <span className="text-[#5A5048] text-xs font-semibold flex-1">1 coach evaluation due</span>
            ...
            <div>
              <div className="flex items-center justify-between mb-4">
                ...
                {!editing && (
                  <button onClick={() => setEditing(true)} className="flex items-center gap-1 text-[#C49A3C] text-xs font-semibold hover:text-[#A67E2A] transition-colors">
                    <Pencil size={11} /> Edit
                  </button>
                )}
              </div>
