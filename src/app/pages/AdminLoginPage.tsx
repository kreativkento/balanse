        ...
        <div>
          <Link to="/" className="flex items-center gap-3 mb-12">
            ...
            <div className="flex flex-col leading-none">
              ...
              <span className="text-[#C49A3C]/70 uppercase tracking-widest" style={{ fontSize: '0.44rem', letterSpacing: '0.2em' }}>
                WELLNESS HUB
              </span>
            </div>
          </Link>
          ...
          {/* Admin badge */}
          <div className="inline-flex items-center gap-2 bg-[#C49A3C]/15 border border-[#C49A3C]/35 rounded-full px-4 py-1.5 mb-7">
