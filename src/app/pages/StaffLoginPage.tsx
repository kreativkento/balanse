  ...
  return (
    <div className="min-h-screen bg-[#F8F3E8] flex">
      ...
      <div className="flex-1 flex flex-col justify-center px-6 md:px-16 py-10">
        ...
        {/* Mobile back link */}
        <Link to="/" className="md:hidden flex items-center gap-2 text-[#8A7E6E] text-sm mb-8 hover:text-[#1E2A35] transition-colors">
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <div className="text-right -mt-1">
              <button type="button" className="text-[#C49A3C] text-xs hover:text-[#A67E2A] transition-colors">
                Forgot Password?
              </button>
            </div>
