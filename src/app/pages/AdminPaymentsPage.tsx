            ...
            <div className="bg-[#F8F3E8] rounded-2xl p-4 border border-[#D4CDB5]/40">
              ...
              <div className="flex items-center gap-2.5">
                <div className="w-9 h-9 rounded-xl bg-[#C49A3C]/12 border border-[#C49A3C]/25 flex items-center justify-center">
                  <span className="text-[#A67E2A] text-xs font-bold">{payment.student.split(' ').map(n => n[0]).join('').slice(0, 2)}</span>
                </div>
                <div>
      ...
      <div className="bg-white rounded-3xl border border-[#D4CDB5]/60 shadow-2xl w-full max-w-lg my-4">
        ...
        {payment.status === 'approved' && (
          <div className="px-7 pb-7 flex gap-2">
            <button
              onClick={onReissue}
              className="flex-1 py-2.5 rounded-full bg-[#C49A3C]/10 text-[#A67E2A] border border-[#C49A3C]/30 text-sm font-bold hover:bg-[#C49A3C]/20 active:scale-95 transition-all flex items-center justify-center gap-1.5"
            >
