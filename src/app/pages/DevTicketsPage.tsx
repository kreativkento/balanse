...
const PRIORITY_STYLE: Record<TicketPriority, string> = {
  ...
  medium: 'bg-[#C49A3C]/15 text-[#A67E2A]',
          ...
          {loading ? (
            ...
            <div className="px-6 py-16 text-center">
              ...
              <button
                type="button"
                onClick={() => { resetForm(); setShowCreate(true); }}
                className="inline-flex items-center gap-2 text-sm font-semibold text-[#A67E2A] hover:text-[#1E2A35] transition-colors"
              >
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-wrap items-center gap-2 mb-1.5">
                        ...
                        <span className={`text-[0.65rem] font-bold uppercase tracking-wide px-2 py-0.5 rounded-full ${
                          ticket.level === 2 ? 'bg-[#C49A3C]/20 text-[#A67E2A]' : 'bg-[#EDE8D8] text-[#5A5048]'
                        }`}>
