  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ backgroundColor: 'rgba(30,42,53,0.55)', backdropFilter: 'blur(4px)' }}>
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden">
        <div className="px-7 pt-6 pb-4 border-b border-[#D4CDB5]/50 flex items-center justify-between">
        ...
        <div className="px-7 py-5 flex flex-col gap-4 max-h-[60vh] overflow-y-auto">
          ...
          <div className="flex flex-col gap-3">
            {HEALTH_DECLARATION_QUESTIONS.map((q, i) => (
              <div key={i} className="flex items-start gap-3 p-3 rounded-2xl border border-[#D4CDB5]/50 hover:border-[#C49A3C]/30 transition-colors">
                <p className="text-[#5A5048] text-sm flex-1">{q}</p>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4" style={{ backgroundColor: 'rgba(30,42,53,0.55)', backdropFilter: 'blur(4px)' }}>
      <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden">
        ...
        <div className="px-7 py-5 max-h-[55vh] overflow-y-auto" onScroll={handleScroll}>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-3xl border border-[#D4CDB5]/60 shadow-sm p-8 md:p-10">
            ...
            <div className="mb-7">
              ...
              <h1 className="text-[#1E2A35] leading-tight" style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: '2.2rem', letterSpacing: '0.05em' }}>
                Profile Setup
              </h1>
            ...
            <div className="flex items-center gap-3 mb-6 bg-[#F8F3E8] rounded-2xl px-4 py-3 border border-[#D4CDB5]/50">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[#8A7E6E] text-xs">Account Created</span>
              </div>
              <div className="flex-1 h-px bg-[#C49A3C]" />
              <div className="flex items-center gap-2">
                <div className="w-6 h-6 rounded-full bg-[#C49A3C] flex items-center justify-center shrink-0">
                  <span className="text-white text-xs font-bold">2</span>
                </div>
                <span className="text-[#A67E2A] text-xs font-semibold">Profile Setup</span>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4" noValidate>
              ...
              <div className="bg-[#F8F3E8] rounded-2xl border border-[#D4CDB5]/60 p-4 flex flex-col gap-3">
                <div className="flex items-center gap-2 mb-1">
                  <User size={13} className="text-[#C49A3C]" />
                  <p className="text-[#5A5048] text-sm font-semibold">Full Name</p>
                  <span className="ml-auto text-[#B0A898] text-xs">From registration</span>
                </div>
                ...
                <div className="flex gap-3">
                  ...
                  <div className="w-20">
                    <label className="text-[#8A7E6E] text-xs mb-1.5 block">M.I. <span className="text-[#C0B8A8]">(opt.)</span></label>
                    <input
                      type="text"
                      value={middleInitial}
                ...
                <div className="grid grid-cols-3 gap-2">
                  {([['male', 'Male'], ['female', 'Female'], ['prefer_not_to_say', 'Prefer not to say']] as const).map(([val, label]) => (
                    <button
                      ...
                      className={`py-3 px-2 rounded-2xl border-2 text-xs font-semibold transition-all ${sex === val ? 'border-[#C49A3C] bg-[#C49A3C]/08 text-[#C49A3C]' : 'border-[#D4CDB5]/60 bg-[#F8F3E8] text-[#5A5048] hover:border-[#C49A3C]/40'}`}
                    >
                      {label}
                    </button>
                  ))}
              ...
              <div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {/* Health Declaration */}
                  <div className={`flex items-center gap-3 p-4 rounded-2xl border transition-all ${healthSigned ? 'border-green-300 bg-green-50' : errors.health ? 'border-red-300 bg-red-50/30' : 'border-[#D4CDB5]/60'}`}>
                    ...
                    {healthSigned ? (
                      ...
                      <button
                        ...
                        className="flex items-center gap-1 text-[#C49A3C] text-xs font-bold border border-[#C49A3C]/40 px-3 py-1.5 rounded-xl hover:bg-[#C49A3C]/08 transition-all"
                      >
                  ...
                  {/* Terms & Conditions */}
                  <div className={`flex items-center gap-3 p-4 rounded-2xl border transition-all ${termsSigned ? 'border-green-300 bg-green-50' : errors.terms ? 'border-red-300 bg-red-50/30' : 'border-[#D4CDB5]/60'}`}>
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[#9A8E7E] text-xs">{termsSigned ? `Accepted ✓ (Updated ${TC_LAST_UPDATED})` : `Last Updated: ${TC_LAST_UPDATED}`}</p>
                    </div>
                    {termsSigned ? (
                      <div className="w-7 h-7 rounded-full bg-green-100 flex items-center justify-center">
                        <Check size={13} className="text-green-600" strokeWidth={3} />
