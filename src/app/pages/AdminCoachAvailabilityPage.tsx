...
const COACHES: Coach[] = [
  {
    ...
    availability: [
      { id: 101, date: '2026-07-28', dayOff: false, note: '', periods: [{ id: 1011, start: '07:00', end: '09:00' }, { id: 1012, start: '14:00', end: '17:00' }] },
      { id: 102, date: '2026-07-29', dayOff: false, note: '', periods: [{ id: 1021, start: '07:00', end: '09:00' }] },
      { id: 103, date: '2026-07-30', dayOff: true,  note: 'Personal leave', periods: [] },
      { id: 104, date: '2026-07-31', dayOff: false, note: '', periods: [{ id: 1041, start: '07:00', end: '10:00' }] },
    ],
  },
  {
    id: 2, name: 'Jodi Reyes', initials: 'JO', color: '#E8A87C', role: 'Yoga',
    availability: [
      { id: 201, date: '2026-07-28', dayOff: false, note: '', periods: [{ id: 2011, start: '08:00', end: '11:00' }] },
      { id: 202, date: '2026-07-29', dayOff: false, note: '', periods: [{ id: 2021, start: '08:00', end: '10:00' }] },
      { id: 203, date: '2026-08-03', dayOff: false, note: 'Back from Bali retreat', periods: [{ id: 2031, start: '08:00', end: '12:00' }] },
    ],
  },
  {
    id: 3, name: 'Ephraim Cruz', initials: 'EP', color: '#7A7EBC', role: 'Animal Flow',
    availability: [
      { id: 301, date: '2026-07-28', dayOff: false, note: '', periods: [{ id: 3011, start: '09:00', end: '11:00' }] },
      { id: 302, date: '2026-07-29', dayOff: true,  note: 'Medical appointment', periods: [] },
    ],
  },
  {
    id: 4, name: 'Alec Navarro', initials: 'AL', color: '#A8806A', role: 'Groundworks',
    availability: [
      { id: 401, date: '2026-07-28', dayOff: false, note: '', periods: [{ id: 4011, start: '11:00', end: '13:00' }] },
      { id: 402, date: '2026-07-30', dayOff: false, note: '', periods: [{ id: 4021, start: '11:00', end: '14:00' }] },
    ],
  },
  {
    id: 5, name: 'Rachelle Lim', initials: 'RC', color: '#B07A9E', role: 'Circuit Training · Stretching',
    availability: [
      { id: 501, date: '2026-07-28', dayOff: false, note: '', periods: [{ id: 5011, start: '16:00', end: '19:00' }] },
      { id: 502, date: '2026-07-29', dayOff: false, note: '', periods: [{ id: 5021, start: '16:00', end: '18:00' }] },
    ],
  },
  {
    id: 6, name: 'Kate Mercado', initials: 'KT', color: '#C49A3C', role: 'Mat Pilates',
    availability: [
      { id: 601, date: '2026-07-28', dayOff: false, note: '', periods: [{ id: 6011, start: '09:30', end: '12:00' }] },
      { id: 602, date: '2026-07-31', dayOff: false, note: '', periods: [{ id: 6021, start: '09:30', end: '11:30' }] },
      { id: 603, date: '2026-08-01', dayOff: true,  note: 'Studio event conflict', periods: [] },
    ],
  },
  {
    id: 7, name: 'Wolf Andrada', initials: 'WF', color: '#3A4A5A', role: 'Kickboxing',
    availability: [
      { id: 701, date: '2026-07-28', dayOff: false, note: '', periods: [{ id: 7011, start: '17:00', end: '20:00' }] },
      { id: 702, date: '2026-07-29', dayOff: false, note: '', periods: [{ id: 7021, start: '17:00', end: '19:00' }] },
    ],
  },
];
              ...
              <div className="flex flex-col gap-2">
                {entry.periods.map(p => (
                  <div key={p.id} className="flex items-center gap-2 bg-[#F8F3E8] rounded-xl border border-[#D4CDB5]/50 px-3 py-2">
                    ...
                    <span className="text-[#1E2A35] text-sm font-medium">{fmt12(p.start)}</span>
                    <span className="text-[#B0A898] text-xs">–</span>
                    <span className="text-[#1E2A35] text-sm font-medium">{fmt12(p.end)}</span>
                  </div>
                ))}
              </div>
            </div>
          ...
          <div className="flex-1 min-w-0 flex gap-5 items-start">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="bg-white rounded-3xl border border-[#D4CDB5]/60 shadow-sm overflow-hidden">
                <div className="grid grid-cols-[1.4fr_90px_1.8fr_80px] gap-x-4 px-5 py-3 border-b border-[#D4CDB5]/50 bg-[#F8F3E8]/60">
                ...
                {coach.availability.length === 0 ? (
                  ...
                  <div className="divide-y divide-[#D4CDB5]/30">
                    {[...coach.availability].sort((a, b) => a.date.localeCompare(b.date)).map(entry => (
                      <div key={entry.id} className="grid grid-cols-[1.4fr_90px_1.8fr_80px] gap-x-4 px-5 py-3.5 items-start hover:bg-[#F8F3E8]/40 transition-colors min-h-[60px]">
                        <div>
                          <p className="text-[#1E2A35] text-sm font-semibold">{formatDateShort(entry.date)}</p>
