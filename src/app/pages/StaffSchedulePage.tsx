...
export default function StaffSchedulePage() {
  ...
  const [availSlots, setAvailSlots] = useState<AvailabilitySlot[]>([
    { id: 1, date: '2026-04-21', times: ['8:00 AM', '9:00 AM', '10:00 AM'], available: true },
    { id: 2, date: '2026-04-22', times: ['7:00 AM', '8:00 AM'], available: true },
    { id: 3, date: '2026-04-23', times: ['9:00 AM', '10:00 AM', '11:00 AM'], available: false },
  ]);
  const [availCalYear, setAvailCalYear] = useState(2026);
  const [availCalMonth, setAvailCalMonth] = useState(3);
  ...
  const availGrid = buildGrid(availCalYear, availCalMonth);
              ...
              <div className="bg-white rounded-3xl border border-[#D4CDB5]/60 shadow-sm p-5 sticky top-6">
                ...
                <div className="grid grid-cols-7 gap-y-0.5">
                  {availGrid.map((day, idx) => {
                    ...
                    const key = toKey(availCalYear, availCalMonth, day);
