                ...
                {pricingPlans.map((plan) => (
                  ...
                  >
                    ...
                    <div className="text-right ml-3 shrink-0">
                      <span
                        className={`font-black text-xl ${plan.highlight ? 'text-[#C49A3C]' : 'text-[#1E2A35]'}`}
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      onClick={() => navigate('/classes')}
                      className="text-[#C49A3C] text-sm font-semibold flex items-center gap-1 active:opacity-70"
                    >
