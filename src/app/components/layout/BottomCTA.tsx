  ...
  return (
    <>
      ...
      <div className="md:hidden bg-gradient-to-t from-[#F8F3E8] via-[#F8F3E8]/95 to-transparent pt-3 pb-5 px-5 border-t border-[#D4CDB5]/60">
        <button
          onClick={handleClick}
          className="w-full flex items-center justify-center gap-2 bg-[#745b3c] text-white font-bold text-base rounded-full py-4 min-h-[56px] shadow-[0_4px_24px_rgba(116,91,60,0.4)] active:scale-[0.97] transition-all hover:bg-[#5e4a30]"
        >
          <Calendar size={20} />
          {label}
        </button>
      ...
      <div className="hidden md:block bg-[#1E2A35] border-t border-[#D4CDB5]/20">
        <div className="max-w-6xl mx-auto px-8 py-14 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <button
            onClick={handleClick}
            className="shrink-0 flex items-center gap-2 bg-[#745b3c] text-white font-bold text-base px-8 py-4 rounded-full shadow-[0_4px_24px_rgba(116,91,60,0.4)] hover:bg-[#5e4a30] transition-colors active:scale-[0.97] whitespace-nowrap"
          >
            <Calendar size={20} />
            {label}
          </button>
