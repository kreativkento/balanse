...
export function ProfileIncompleteState({
  ...
  return (
    <div className={`flex flex-col items-center justify-center text-center ${compact ? 'py-8 px-4' : 'py-14 px-6'}`}>
      <div className={`rounded-2xl bg-[#C49A3C]/08 border border-[#C49A3C]/20 flex items-center justify-center mb-4 ${compact ? 'w-12 h-12' : 'w-16 h-16'}`}>
        <UserCircle size={compact ? 22 : 28} className="text-[#C49A3C]" />
      </div>
      <h3
      ...
      <button
        ...
        className="mt-5 flex items-center gap-2 bg-[#C49A3C] text-white px-6 py-3 rounded-full text-sm font-bold shadow-[0_4px_16px_rgba(196,154,60,0.3)] hover:bg-[#A67E2A] active:scale-[0.97] transition-all"
